 ...
 * Description:       Backup Guard is the most complete WordPress site backup and restore plugin. We offer the easiest way to backup, restore or migrate your site. You can backup your files, database or both.
 * Version:           1.1.55
 * Author:            BackupGuard
...
if (!defined('SG_BACKUP_GUARD_VERSION')) {
	define('SG_BACKUP_GUARD_VERSION', '1.1.55');
}
