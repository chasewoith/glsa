...
define('SG_RELOAD_METHOD_STREAM', 'stream');
define('SG_RELOAD_METHOD_CURL', 'curl');
define('SG_RELOAD_METHOD_SOCKET', 'socket');
define('SG_RELOAD_INTERVAL', 15);
...
//Notifications
define('SG_NOTIFICATION_SHOULD_CONTINUE_ACTION', 'SG_NOTIFICATION_SHOULD_CONTINUE_ACTION');
define('SG_NOTIFICATION_SAVE_ACTION_STATE', 'SG_NOTIFICATION_SAVE_ACTION_STATE');
define('SG_NOTIFICATION_SAVE_DB_ACTION_STATE', 'SG_NOTIFICATION_SAVE_DB_ACTION_STATE');
define('SG_NOTIFICATION_SAVE_FILES_ACTION_STATE', 'SG_NOTIFICATION_SAVE_FILES_ACTION_STATE');
define('SG_NOTIFICATION_SAVE_STORAGE_ACTION_STATE', 'SG_NOTIFICATION_SAVE_STORAGE_ACTION_STATE');
define('SG_NOTIFICATION_DID_FINISH_BACKUP', 'SG_NOTIFICATION_DID_FINISH_BACKUP');
