...
define('SG_BACKUP_FILE_PATHS_EXCLUDE', $wpContent.'/'.$wpPlugins.'/backup-guard/,'.$wpContent.'/'.$wpPlugins.'/backup-guard-pro/,'.$wpContent.'/'.$wpUploads.'/backup-guard/,'.$wpContent.'/'.$wpUploads.'/sg_symlinks/');
