...
<div id="sg-content-wrapper">
    <div class="container-fluid">
        <fieldset>
            ...
            <a href="javascript:void(0)" id="sg-backup-with-migration" class="pull-left btn btn-primary" data-toggle="modal" data-modal-name="manual-backup" data-remote="modalManualBackup" sg-data-backup-type="<?php echo SG_BACKUP_METHOD_MIGRATE ?>">
                <i class="glyphicon glyphicon-duplicate"></i>
                <?php _backupGuardT('Migrate')?>
                <?php if (!SGBoot::isFeatureAvailable('BACKUP_WITH_MIGRATION')): ?>
                    <span class="badge sg-badge-warning" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo SG_SILVER_TOOLTIP_TEXT?>" data-container="#sg-wrapper"><?php echo SG_BADGE_SILVER_PLUS_TEXT ?></span>
                <?php endif;?>
            </a>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                ...
                                <?php if(file_exists(SG_BACKUP_DIRECTORY.$backup['name'].'/'.$backup['name'].'.sgbp')):?>
                                    <a href="javascript:void(0)" title="<?php _backupGuardT('Restore')?>" class="btn btn-success btn-xs" data-toggle="modal" data-modal-name="manual-restore" data-remote="modalManualRestore" data-sgbp-params="<?php echo $backup['name']?>">
