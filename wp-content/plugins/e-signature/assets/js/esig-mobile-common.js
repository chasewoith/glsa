(function ($) {
    ...
    $("#mobile-next-step").on("tap", function () {
    ...
    $("#mobile-go-back").on("tap", function () {
...
// closing popup when click on close button
    $("#esig-mobile-sig-close").on("tap", function () {
