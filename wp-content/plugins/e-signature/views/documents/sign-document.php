...
<div class="document-sign-page">
	...
	<p class="doc_title" id="doc_title"><?php if(array_key_exists('document_title', $data)) { echo $data['document_title'];} ?></p>
    <br />
...
<?php  if (wp_is_mobile()) : ?>
    ...
    <div class="modal-content">
        ...
        <div class="container sig-footer">
            <div class="row">
                <div class="col-sm-12">
                       <a href="#" id="esig-mobile-sig-close"><?php _e('Close','esig'); ?></a>
                </div>
            </div>
        </div>
