...
<div id="esig-support" class="postbox">
	...
	<h3 class="hndle esig-section-title"><span><?php _e('Found a bug? Need support?', 'esig' ); ?></span></h3>
		...
		{
			?>
        <p><a id="esig-report-bug" class="button-secondary" href="https://www.approveme.com/wp-digital-e-signature-document-support/" target="_blank"><?php _e('Report a Bug', 'esig' ); ?></a></p>
	
	<p> <a target="_blank" class="button-secondary" href="https://www.approveme.com/wp-digital-e-signature-document-support"><?php _e('Open a Support Ticket', 'esig' );?></a></p>	
	<?php } ?>
